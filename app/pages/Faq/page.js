...
const Faq = () => {
  ...
  const questions = [
    {
      question: "1. What makes WRIGHTS different from traditional training programs?",
      answer:
    ...
    {
      question: "6. Can WRIGHTS training be tailored to specific organizational needs?",
      answer:
    ...
    {
      question: "9. How long does it take to see results from WRIGHTS training?",
      answer:
      ...
      <div className="faq">
        <div className="faqContainer">
          <div className="faqContent">
            ...
            <p>
            Clarify every doubt and learn how WRIGHTS transforms employee behavior. Discover the science behind our nudges, data-driven insights, and AI-powered solutions right here.
            </p>
