...
const Product = () => {
  ...
  const animationRef = useRef(null); // Renamed reference
      ...
      <div className="product">
        <div className="productContainer">
          <div className="productContent">
            ...
            <p>
            Leverage AI-driven insights, ultra-customized nudges, and measurable outcomes to inspire lasting change — only with WRIGHTS.
            </p>
        ...
        <div className="productSection2Container">
          ...
          <div className="productSection2Cotent">
            ...
            <div className="section2Cotent">
              <p>
                <span>What It Is:</span> Collect insights from peers, managers,
                and direct reports to gain a well-rounded perspective on each
                employee's growth areas.
              </p>
              <p>
                <span>Why It Matters:</span> Helps identify blind spots and
                improvement opportunities that traditional reviews may overlook.
              </p>
            </div>
          </div>
          <div className="productSection2Cotent">
            <div className="section2Head">
              <h2>
              Action-Oriented Micro-Prompts
              </h2>
            </div>
            <div className="section2Cotent">
              <p>
                <span>What It Is:</span>  Short, timely reminders (nudges) encouraging employees to improve communication, collaborate effectively, and exhibit leadership qualities
              </p>
              <p>
                <span>Why It Matters:</span> These bite-sized prompts are easy to act on, making behavioral change more sustainable.
              </p>
            </div>
          </div>
          <div className="productSection2Cotent">
            ...
            <div className="section2Cotent">
              <p>
                <span>What It Is:</span>  Our tool segments employees based on personality traits, motivations, values, and attitudes.
              </p>
              <p>
                <span>Why It Matters:</span> By understanding what truly drives each individual, we can craft ultra-customized nudges that resonate more deeply, increasing engagement and long-term adoption of desired behaviors.
              </p>
            </div>
          </div>
          <div className="productSection2Cotent">
            ...
            <div className="section2Cotent">
              <p>
                <span>What It Is:</span> A dashboard tracks progress, measures employee engagement, and provides analytics to refine nudges.
              </p>
              <p>
                <span>Why It Matters:</span> Immediate visibility into what's working (and what's not) allows for rapid adjustments, ensuring effective results.
              </p>
            </div>
          </div>
          <div className="productSection2Cotent">
            ...
            <div className="section2Cotent">
              <p>
                <span>What It Is:</span> An intuitive interface that makes it easy for employees to read and act on feedback without feeling overwhelmed.
              </p>
              <p>
                <span>Why It Matters:</span>oLow learning curve means higher adoption and consistent usage across the organization.
              </p>
            </div>
          </div>
          </div>
